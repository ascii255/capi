...
void enable_flag_enum(test_flgd_flag);
...
using tracked_flgd =
  unique_flgd<test_flgd_flag::read, init_flag, quit_flag, query_flags, std::to_underlying(test_flgd_flag::read)>;
using failing_flgd =
  unique_flgd<test_flgd_flag::write, fail_init_flag, quit_flag, query_flags, std::to_underlying(test_flgd_flag::write)>;
